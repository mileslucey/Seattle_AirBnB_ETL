...
* A MySQL database connection is created and an engine is created in Python(**if reproducing, make sure that <PASSWORD HERE> contains the appropriate computer password**):
   ~~~~python
